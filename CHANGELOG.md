...
- Updated [golang-coding-rules-and-best-practices-v1.md](coding/golang-coding-rules-and-best-practices-v1.md) (`document version: 1.2`; previous freeze: `…-v1.1.md`) — **Keytiles patterns** section links Codebase Naming and Source Anchoring; removed redundant `coding/keytiles-patterns/golang-coding-rules-and-best-practices-v1.md` wrapper (this repo is Keytiles-specific, so one Go rules head is enough).
- Updated [golang-coding-rules-and-best-practices-v1.md](coding/golang-coding-rules-and-best-practices-v1.md) (`document version: 1.3`; previous freeze: `…-v1.2.md`) — **Logging / VarPrinter**: lazy formatting via `VarPrinter` (avoid `PrintVarS` and eager `string(bytes)` in log args); `BytesAsString` for `[]byte` text payloads; quick-reference table; points to `lib-utils-golang` `VarPrinting-v1.3.md`; requires `lib-utils-golang/v2` **2.1.0+**.
